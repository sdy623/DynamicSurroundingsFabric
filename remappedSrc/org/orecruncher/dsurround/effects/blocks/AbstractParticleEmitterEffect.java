...
public abstract class AbstractParticleEmitterEffect extends AbstractBlockEffect {
    ...
    public AbstractParticleEmitterEffect(World world, double x, double y, double z) {
        this(1, world, x, y, z);
    }

    public AbstractParticleEmitterEffect(int strength, World world, double x, double y, double z) {
        this(strength, world, x, y, z, 3);
    }

    public AbstractParticleEmitterEffect(int strength, World world, double x, double y, double z, int freq) {
        super(world, x, y, z);
