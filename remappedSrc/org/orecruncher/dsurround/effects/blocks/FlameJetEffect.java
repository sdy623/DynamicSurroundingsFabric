...
public class FlameJetEffect extends AbstractParticleEmitterEffect {
    ...
    private static final Identifier FIRE_AMBIENT = new Identifier(Constants.MOD_ID, "fire_ambient");
    ...
    public FlameJetEffect(final int strength, final World world, final double x, final double y, final double z, boolean isNonLiquidBlock) {
