...
public abstract class BlockEffectProducer implements IBlockEffectProducer {
    ...
    protected boolean canTrigger(World world, BlockState state, BlockPos pos, IRandomizer rand) {
    ...
    @Override
    public Optional<IBlockEffect> produce(World world, BlockState state, BlockPos pos, IRandomizer rand) {
    ...
    protected abstract Optional<IBlockEffect> produceImpl(World world, BlockState state, BlockPos pos, IRandomizer rand);
