...
public class BlockParticleEffectProducer extends BlockEffectProducer {
    ...
    @Override
    final protected Optional<IBlockEffect> produceImpl(World world, BlockState state, BlockPos pos, IRandomizer rand) {
    ...
    public interface IParticleSupplier {
        Particle create(World world, BlockState state, BlockPos pos, IRandomizer rand);
    }
}
