...
public final class ClientState {
    ...
    private static void connectionDetector(MinecraftClient client) {
    ...
    public interface IClientStarted {
        void onStart(MinecraftClient client);
    }

    @FunctionalInterface
    public interface IClientStopping {
        void onStopping(MinecraftClient client);
    }

    @FunctionalInterface
    public interface IClientTickStart {
        void onTickStart(MinecraftClient client);
    }

    @FunctionalInterface
    public interface IClientTickEnd {
        void onTickEnd(MinecraftClient client);
    }

    @FunctionalInterface
    public interface IClientConnect {
        void onConnect(MinecraftClient client);
    }
    ...
    public interface ITagSync {
        void onTagSync(DynamicRegistryManager registryAccess);
    }
