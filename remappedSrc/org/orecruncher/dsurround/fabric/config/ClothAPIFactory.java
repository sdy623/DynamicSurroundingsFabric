...
public class ClothAPIFactory extends AbstractConfigScreenFactory {
    ...
    public static IScreenFactory<?> createDefaultConfigScreen(Class<? extends ConfigurationData> configClass) {
        ...
        ConfigOptions options = new ConfigOptions()
                ...
                .setTitleStyle(Style.EMPTY.withColor(ColorPalette.PUMPKIN_ORANGE.getRgb()))
                .setPropertyGroupStyle(Style.EMPTY.withColor(ColorPalette.GOLDENROD.getRgb()))
                .setPropertyStyle(Style.EMPTY.withColor(ColorPalette.WHEAT.getRgb()))
                .setTooltipStyle(Style.EMPTY.withColor(ColorPalette.SEASHELL.getRgb()))
                .wrapToolTip(true);
    ...
    protected SubCategoryBuilder generate(final ConfigEntryBuilder builder, ConfigElement.PropertyGroup propertyGroup, Object instance) {
        SubCategoryBuilder categoryBuilder = builder
                ...
                .setTooltip(this.options.transformTooltip(propertyGroup.getTooltip(this.options.getTooltipStyle())).toArray(new Text[0]));
    ...
    private Text[] generateToolTip(ConfigElement.PropertyValue<?> pv) {
        return this.generateToolTipCollection(pv).toArray(new Text[0]);
   }
}