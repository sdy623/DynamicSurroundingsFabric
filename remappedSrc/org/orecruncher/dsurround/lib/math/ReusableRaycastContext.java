...
public class ReusableRaycastContext extends RaycastContext {
    ...
    public ReusableRaycastContext(World world, RaycastContext.ShapeType shapeType, RaycastContext.FluidHandling fluidHandling) {
        this(world, Vec3d.ZERO, Vec3d.ZERO, shapeType, fluidHandling);
    }

    public ReusableRaycastContext(World world, Vec3d start, Vec3d end, RaycastContext.ShapeType shapeType, RaycastContext.FluidHandling fluidHandling) {
    ...
    public ReusableRaycastContext(World world, Vec3d start, Vec3d end, RaycastContext.ShapeType shapeType, RaycastContext.FluidHandling fluidHandling, Entity entity) {
