...
public final class ResourceUtilities {
    ...
    public Collection<TagFile> findClientTagFiles(TagKey<?> tagKey) {
        ...
        var tagDir = TagManagerLoader.getPath(tagKey.registry());
        var tagFolder = "%s/%s".formatted(tagDir, tagKey.id().getPath());
        var tagFolderPack = "%s:%s".formatted(tagKey.id().getNamespace(), tagFolder);
