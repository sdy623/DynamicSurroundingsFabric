...
public abstract class CuboidScanner extends Scanner {
     ...
     */
    public void blockUnscan(final World world, final BlockState state, final BlockPos pos, final IRandomizer rand) {
    ...
    @Override
    @Nullable
    protected BlockPos nextPos(final BlockPos.Mutable workingPos, final IRandomizer rand) {
