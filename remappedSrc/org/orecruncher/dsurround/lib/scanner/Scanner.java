...
public abstract class Scanner {
     ...
     * copied.
     */
    public abstract void blockScan(final World world, final BlockState state, final BlockPos pos, final IRandomizer rand);
     ...
     */
    @Nullable
    protected abstract BlockPos nextPos(final BlockPos.Mutable pos, final IRandomizer rand);
