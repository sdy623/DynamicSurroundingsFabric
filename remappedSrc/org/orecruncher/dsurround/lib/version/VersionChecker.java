    ...
    private Optional<VersionResult> getUpdateText(VersionInformation info) {
        ...
        if (mcVersion.isPresent()) {
            ...
            if (newest.isPresent()) {
                ...
                return Optional.of(new VersionResult(version.toString(), this.modInfo.modId(), Formatting.strip(this.modInfo.displayName()), this.modInfo.curseForgeLink(), this.modInfo.modrinthLink(), releaseNotes));
            }
        }
