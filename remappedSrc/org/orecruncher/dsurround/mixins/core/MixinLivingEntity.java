...
public class MixinLivingEntity implements ILivingEntityExtended {
    ...
    @Final
    @Shadow
    private static TrackedData<Integer> DATA_EFFECT_COLOR_ID;
    ...
    public int dsurround_getPotionSwirlColor() {
        ...
        return entity.getDataTracker().get(DATA_EFFECT_COLOR_ID);
    }

    @Override
    public void dsurround_setPotionSwirlColor(int color) {
        var entity =  ((LivingEntity)((Object)this));
        entity.getDataTracker().set(DATA_EFFECT_COLOR_ID, color);
    }
}
