...
import org.orecruncher.dsurround.Configuration.EnhancedSounds;
...
public final class SoundFXProcessor {
    ...
    private static void onGatherText(CollectDiagnosticsEvent event ) {
        if (isAvailable() && soundProcessor != null) {
            ...
            event.getSectionText(CollectDiagnosticsEvent.Section.Systems).add(Text.literal("Enhanced sound processing disabled"));
        }
    }
}
