...
public class PlayerVariables extends VariableSet<IPlayerVariables> implements IPlayerVariables {
    ...
    public void update(IVariableAccess variableAccess) {
        ...
        if (GameUtils.isInGame()) {
            ...
            var hm = player.getHungerManager();
            ...
            this.isWet = player.isTouchingWaterOrRain();
    ...
    public boolean hasEffect(String effect) {
        try {
            ...
            var r = RegistryUtils.getRegistryEntry(RegistryKeys.STATUS_EFFECT, id).orElseThrow();
            return GameUtils.getPlayer().map(p -> p.hasStatusEffect(r.value())).orElse(false);
